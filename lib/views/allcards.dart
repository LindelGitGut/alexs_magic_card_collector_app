...
Widget allcards({required Function themeCallBack, required Function updateCardResults,
    required BuildContext context, required List<MagicCardModel> cardresults}) {
  return Column(
    children: [
      FutureBuilder(
          future: searchBar(
